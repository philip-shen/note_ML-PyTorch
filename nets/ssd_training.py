'''
    ssd-pytorch/nets/ssd_training.py

https://github.com/bubbliiiing/ssd-pytorch/blob/master/nets/ssd_training.py    
'''
import math
...
def weights_init(net, init_type='normal', init_gain=0.02):
    ...
    #logger.info(f'initialize network with {init_type} type')
    net.apply(init_func)
