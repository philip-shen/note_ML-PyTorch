'''
pytorch_advanced/3_semantic_segmentation/3-3-6_NetworkModel.ipynb

https://github.com/YutaroOgawa/pytorch_advanced/blob/master/3_semantic_segmentation/3-3-6_NetworkModel.ipynb
'''
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='ML_Pytorch_25-2_network_model')
