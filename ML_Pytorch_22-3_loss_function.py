'''
pytorch_advanced/2_objectdetection/2-6_loss_function.ipynb

https://github.com/YutaroOgawa/pytorch_advanced/blob/master/2_objectdetection/2-6_loss_function.ipynb
'''
# パッケージのimport
import torch
